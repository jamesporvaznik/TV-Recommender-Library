...
function Recommendations({shows, addTerm, setAddTerm, onAdd, onClear, onView, onHide, onGenerate, onSearchQuery}) {
    ...
    // Render the form
    return (
    // *** Wrap the adjacent elements in a single Fragment ***
        <> 
            {currentMode === RECOMMENDATION_MODES.ADD ? (
                ...
                <p>Recommendation by Search</p>
            ) : currentMode === RECOMMENDATION_MODES.LIST ? (
                <p>Recommendation by List</p>
            ) : (
                // Default output
        ...
        //         <p>Recommendation by List</p>
        //     ) : (
        //         // Optional: Default output if none of the above modes match
        //         <p>Select a recommendation mode from the sidebar.</p>
        //     )}
        //     <Drawer 
        //         changeMode={changeMode} 
