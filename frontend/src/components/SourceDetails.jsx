            ...
            <div className="bg-zinc-800 rounded-lg p-6 max-w-2xl w-full shadow-2xl overflow-y-auto max-h-full" onClick={(e) => e.stopPropagation()}>
                ...
                {!isShowDetails && (
                    <>
                        ...
                        <p className="text-gray-400 mb-6"> How it works depends on what mode of recommendation you use. For the "Recommendations by List" mode, the system compares the show overviews from your created list against the overviews of all other shows in the database. Recommendations are generated by summing up the semantic similarities found between them. The "Recommendation from Watched" mode operates similarly to the "Recommendations by List," but introduces a weighting factor. Here, the semantic similarity between show overviews is multiplied by the user's rating for the watched show, giving greater influence to highly-rated similarities. The "Recommendation by Search" mode functions as a direct semantic lookup. It compares the user's search query against all show overviews in the database and orders the results strictly by semantic similarity, from highest to lowest. </p>
